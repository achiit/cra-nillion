...
const SecretForm: React.FC<SecretFormProps> = ({
  ...
  const [showMineGame, setShowMineGame] = useState(false);
  ...
  return isLoading ? (
    ...
    <Box component="form" onSubmit={handleGetQuoteSubmit} sx={{ mt: 2 }}>
      ...
      {!hidePermissions && (
        <TextField
          label="Optional: Set a user id to grant rxetrieve permissions to another user"
